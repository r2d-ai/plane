  ...
  return (
    <>
      {displayState === "neutral" && (
        <Tooltip tooltipContent={t("page_controls.lock")} position="bottom">
          <button
            type="button"
            onClick={toggleLock}
            ...
            aria-label={t("page_controls.lock")}
          >
      ...
      {displayState === "locked" && (
        <button
          ...
          aria-label={t("page_controls.locked")}
        >
      ...
      {displayState === "unlocked" && (
        <div
          ...
          aria-label={t("page_controls.unlocked")}
        >

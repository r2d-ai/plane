        ...
        <>
          ...
          >
            <div className="space-y-1.5">
              <p className="text-11 font-semibold text-tertiary">{t("page_controls.text_colors")}</p>
            ...
            <div className="space-y-1.5">
              <p className="text-11 font-semibold text-tertiary">{t("page_controls.background_colors")}</p>
              <div className="flex items-center gap-2">
                {COLORS_LIST.map((color) => (
                  <button
                    key={color.key}
